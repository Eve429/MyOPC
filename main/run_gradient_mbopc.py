...
def main() -> int:
    ...
    print(f"  loss 权重：nominal={weights['nominal_l2']} "
          f"process={weights['process_l2']} pv={weights['pvband']}")  # 目标函数
