...
def write_advanced_layout(path: Path) -> Path:
    ...
    donut = kdb.Polygon([kdb.Point(0, 150), kdb.Point(100, 150),
                         kdb.Point(100, 250), kdb.Point(0, 250)])
    donut.insert_hole([kdb.Point(25, 175), kdb.Point(25, 225),
                       kdb.Point(75, 225), kdb.Point(75, 175)])
    ...
    top.insert(kdb.CellInstArray(leaf.cell_index(), kdb.Trans(0, 2000),
                                kdb.Vector(300, 0), kdb.Vector(0, 400), 3, 2))
    top.shapes(mask).insert(kdb.Polygon([kdb.Point(-100, -50), kdb.Point(100, -50),
                                        kdb.Point(100, 50), kdb.Point(-100, 50)]))
